...
const en = {
  ...
  'file.removeRecent': 'Remove from Recent',
  ...
  'edit.quote': 'Quote',
  'edit.quoteMenu': 'Quote / Callout',
  'edit.alertNote': 'Note Alert (>[!NOTE])',
  'edit.alertTip': 'Tip Alert (>[!TIP])',
  'edit.alertImportant': 'Important Alert (>[!IMPORTANT])',
  'edit.alertWarning': 'Warning Alert (>[!WARNING])',
  'edit.alertCaution': 'Caution Alert (>[!CAUTION])',
  'edit.bulletedList': 'Bulleted List',
  'edit.numberedList': 'Numbered List',
  'edit.table': 'Table',
  'edit.tableCreator': 'Table Creator…',
  'edit.tableQuick': 'Quick Table (2×2)',
  'edit.tableAddRow': 'Add Row',
  'edit.tableDelRow': 'Delete Row',
  'edit.tableAddCol': 'Add Column',
  'edit.tableDelCol': 'Delete Column',
  'tableCreator.title': 'Table Creator',
  'tableCreator.rows': 'Rows (m)',
  'tableCreator.cols': 'Columns (n)',
  'tableCreator.grid': 'Grid Picker',
  'tableCreator.insert': 'Insert Table',
  'tableCreator.cancel': 'Cancel',
...
const zhCN: Record<MessageKey, string> = {
  ...
  'edit.paragraph': '正文',
  'edit.quote': '引用',
  'edit.quoteMenu': '引用 / 提示框',
  'edit.alertNote': 'Note 提示框 (>[!NOTE])',
  'edit.alertTip': 'Tip 提示框 (>[!TIP])',
  'edit.alertImportant': 'Important 提示框 (>[!IMPORTANT])',
  'edit.alertWarning': 'Warning 提示框 (>[!WARNING])',
  'edit.alertCaution': 'Caution 提示框 (>[!CAUTION])',
  'edit.bulletedList': '无序列表',
  'edit.numberedList': '有序列表',
  'edit.table': '表格',
  'edit.tableCreator': '表格生成器…',
  'edit.tableQuick': '快速表格 (2×2)',
  'edit.tableAddRow': '添加行',
  'edit.tableDelRow': '删除行',
  'edit.tableAddCol': '添加列',
  'edit.tableDelCol': '删除列',
  'tableCreator.title': '表格生成器',
  'tableCreator.rows': '行数 (m)',
  'tableCreator.cols': '列数 (n)',
  'tableCreator.grid': '网格选择',
  'tableCreator.insert': '插入表格',
  'tableCreator.cancel': '取消',
  'edit.codeBlock': '代码块',
  'edit.mathBlock': '数学公式',
